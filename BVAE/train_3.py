...
def train(args, model, sess):
    ...
    best_ndcg5_p, best_ndcg5_cl, best_ndcg5_f = 0., 0., 0.
    best_iter_p, best_iter_cl, best_iter_f = 0, 0, 0
    ...
    for epoch in range(args.epoch):
        ...
        for bnum, st_idx in enumerate(range(0, len(userList_train), args.batch_size)):
            ...
            # target loss
            feed_dict = {model.input_ph_union: D,
                         model.input_ph_behavior1: B1, model.input_ph_behavior2: B2, model.input_ph_behavior3: B3,
